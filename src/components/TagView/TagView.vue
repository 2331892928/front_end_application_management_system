...
export default {
  ...
  methods: {
    ...
    goHome() {
      // const tagView = window.sessionStorage.getItem('tagView')
      // console.log(tagView)
      // if (tagView.length -1 === 0){
      //   router.push(routingArea.console)
      // } else {
      //   console.log(tagView.length)
      //   console.log(tagView.length === 0)
      //   console.log(tagView === [])
      // }
    }
