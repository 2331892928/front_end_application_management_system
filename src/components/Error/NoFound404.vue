<template>
   <div>
<!--     path="https://assets6.lottiefiles.com/datafiles/OzG1c5GtuAvq10U/data.json"-->
    <lottie-web-cimo style="height: 80vh" :animationData="errorContent"/>
...
import {data404} from "src/ErrorData/data404";
