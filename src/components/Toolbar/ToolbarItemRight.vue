      ...
      <q-menu>
        <div class="row no-wrap q-pa-md">
          ...
          <div class="column items-center">
            <q-avatar size="72px">
              <img :src="this.$PUBLIC_PATH + 'data/avatar.jpg'" alt="">
            </q-avatar>
...
import {out} from "src/api/UserApi";
...
export default {
  ...
  data () {
    return {
      ...
      bluetooth: true,
      isMaximize: true,
      username: sessionStorage.getItem('user_name') === null ? 'AMEN' : sessionStorage.getItem('user_name')
    }
  },
  methods: {
    fullScreen () {
